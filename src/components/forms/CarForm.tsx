...
import { useCreateMutation, useUpdateMutation } from "@/store/cars/carsApi";
		...
		>
			...
			>
				...
				<Button
					...
					type="submit"
					className="mt-2 cursor-pointer bg-blue-600 hover:bg-blue-700 text-white w-fit md:text-xl"
					style={{
						borderColor:
							(type.action === "create"
								? createCarData.color
